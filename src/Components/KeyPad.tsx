  ...
  return (
    ...
    <div className="buttons">
      ...
      <Button
          ...
          onClick={onButtonClick}
          className="button-operator"
          dataTestId="negative-positive-button"
        />

        <Button
          text={ButtonNames.squareRoot}
          isDigit={false}
          onClick={onButtonClick}
          className="button-operator"
          dataTestId="reciprocal-button"
